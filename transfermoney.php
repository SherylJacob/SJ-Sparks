...
<div class="main_div">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:#1ac2ff;border-radius:10px;color:white" >
              <form method="POST">  
...
?> 
                    ...
                    <h3 style="color:black;"><b>Sender Details</b></h3>
                  
        
                        <img src="images/10.png" style="width:150px;height:130px;"><br>
                        <label>Name</label>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px; background:transparent; border-color: transparent;">
                   <div class="card-body">
                   <img src="images/6.png" style="width:280px;height:230px;margin-top:40px;"><br>
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:76px;background-color:#cc6699 ;border-radius:10px;color:black">
                   
                   <div class="card-body">
                   <h3><b>Recepient Details</b></h3>
                   <img src="images/10.png" style="width:150px;height:130px;">
                       <br> <label>Name</label>
...
if(isset($_POST['submit']))
{
    ...
    if($arrdata['balance'] >= $Sender)
    {
      ...
      // $res_receiver=mysqli_query($con,$query_receiver);
       if($res && $rec_res)
      {
        $sql = "INSERT INTO `transferdetails`(Sender,Receipient,Amount) VALUES ('$Sender_name','$Receiver_name',' $Sender')";
